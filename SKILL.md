...
description: 'Calculate SPI (Standardized Precipitation Index) and SPEI (Standardized  Precipitation Evapotranspiration Index) from NASA POWER API data for  drought monitoring. Supports multiple timescales (1-24 months), drought  classification, and trend analysis.  '
---
